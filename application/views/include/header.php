    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li <?php if ($this->uri->segment(2) == "quiz") {
                echo 'class="active"';
              } ?>>
            <a href="<?= base_url(); ?>admin/quiz"><i class="fa fa-file"></i> Quiz</a>
          </li>
          <li <?php if ($this->uri->segment(2) == "test") {
                echo 'class="active"';
              } ?>>
            <a href="<?= base_url(); ?>admin/test"><i class="fa fa-book"></i> Test</a>
          </li>
