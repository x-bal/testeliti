            ...
            <form role="form" action="<?= base_url(); ?>admin/save_edit_users" enctype="multipart/form-data" method="post" accept-charset="utf-8">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <label>Nama Users</label>
                  <input type="text" name="users" class="form-control" value="<?php if (isset($nama)) {
                                                                                echo $nama;
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="password" name="pass" class="form-control" value="<?php if (isset($password)) {
                                                                                      echo $password;
                                                                                    } ?>">
                ...
                <div class="form-group">
                  <img src="<?= base_url(); ?>components/dist/img/<?php if (isset($avatar)) {
                                                                  echo $avatar;
                                                                } ?>" width="auto" height="200px"><br>
                  <input type="hidden" name="img" value="<?php if (isset($avatar)) {
                                                            echo $avatar;
                                                          } ?>">
                  <label for="InputFile">Pilih Foto ("jpg", "jpeg", "gif", "png")</label>
